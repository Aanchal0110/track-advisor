...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-career-bg-start to-career-bg-end flex items-center justify-center p-4">
        ...
        <Card className="border-0 shadow-elegant bg-card/90 backdrop-blur-sm">
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full">
              ...
              {error && (
                <div className="flex items-center space-x-2 text-destructive text-sm mt-4 p-3 bg-destructive/10 rounded-md">
