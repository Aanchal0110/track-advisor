...
-- Update existing subjects with sample resources
UPDATE subjects SET resources = '{
  "beginner": {
    "videos": [
...
-- Add more questions for other tracks (AI/ML)
INSERT INTO quiz_questions (track_id, question_text, options, correct_answer, difficulty, explanation) VALUES 
