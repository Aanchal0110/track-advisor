...
-- Insert sample quiz questions with proper difficulty distribution
INSERT INTO quiz_questions (track_id, question_text, options, correct_answer, difficulty, explanation) VALUES 
-- Data Analytics - Beginner Questions (40%)
((SELECT id FROM tracks WHERE track_name = 'Data Analytics'), 
...
-- Data Analytics - Intermediate Questions (30%)
((SELECT id FROM tracks WHERE track_name = 'Data Analytics'), 
...
-- Data Analytics - Hard Questions (30%)
((SELECT id FROM tracks WHERE track_name = 'Data Analytics'), 
...
-- AI/ML Questions
INSERT INTO quiz_questions (track_id, question_text, options, correct_answer, difficulty, explanation) VALUES 
-- AI/ML - Beginner Questions
((SELECT id FROM tracks WHERE track_name = 'AI/ML'), 
